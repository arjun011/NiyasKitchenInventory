...
struct AddEditInventoryView: View {
    ...
    var body: some View {
        ...
        VStack {
                ...
                Section {
                    ...
                    HStack(
                        ...
                        content: {
                            ...
                            TextField(
                                "Quantity", value: $vm.quantity, format: .number
                            )
                ...
                Section {
                    Menu {
                        ...
                        HStack {
                            ...
                            Text(vm.selectedCategory?.name ?? "Choose Category")
                                .foregroundStyle(
                    ...
                    Menu {
                        ...
                        HStack {
                            Image(systemName: "person.2.fill")
                                .foregroundStyle(Color("BrandPrimary"))
                            Text(vm.selectedSupplier?.name ?? "Choose supplier")
                                .foregroundStyle(
        ...
        ).alert("Categoery", isPresented: $vm.showAddCategory, actions: {
            ...
            Button("Save", action: {
                ...
                guard !vm.categoryName.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty else {
                    return
                }
                
                Task {
                    await vm.saveCategory(category: .init(name: vm.categoryName, lowercasedName: vm.categoryName.trimmingCharacters(in: .whitespacesAndNewlines).lowercased()))
                }
                vm.showAddCategory.toggle()
            })
